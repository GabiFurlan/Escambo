...
<%-- 
 ...
 <div class = "col-sm-6 col-md-3">
 	<% Usuario user = (Usuario) session.getAttribute("user"); 
		int userID = user.getIdUsuario();
		Banco_teste meuBD = new Banco_teste();
		ArrayList<Anuncio> listaDeAnuncios = meuBD.todosAnuncios();
		//ArrayList<Anuncio> listaDeAnuncios = meuBD.listaAnuncios(userID);
		Anuncio meuAnuncio = listaDeAnuncios.get(1); %>
      <div class = "thumbnail">
      	<%	response.setContentType("image/gif");
      		OutputStream o = response.getOutputStream();
      		o.write(meuAnuncio.getImage());
            o.flush(); 
            o.close();
      	%>
      ...
      <div class = "caption">
         <h3> <% out.println(meuAnuncio.getTituloAnuncio()); %></h3>
